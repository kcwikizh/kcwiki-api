            ...
            <div class="ui attached blue segment">
                ...
                <div class="ui relaxed divided list">
                    <div class="item"> <i class="large linkify middle aligned icon"></i>
                        <div class="content">
                            <a class="header" href="//api.kcwiki.moe/tweet/15">舰娘官方推特转发</a>
                            <div class="description">api.kcwiki.moe/tweet/{num}</div>
                        </div>
                    </div>
                    <div class="item"> <i class="large linkify middle aligned icon"></i>
                        <div class="content">
                            <a class="header" href="//api.kcwiki.moe/avatar/latest">舰娘官方推特头像</a>
                    ...
                    <div class="item"> <i class="large linkify middle aligned icon"></i>
                        <div class="content">
                            <a class="header" href="//api.kcwiki.moe/ship/1">舰娘基本信息（例：睦月）</a>
                            <div class="description">api.kcwiki.moe/ship/{ID或舰娘名称}</div>
                        </div>
                    </div>
                    <div class="item"> <i class="large linkify middle aligned icon"></i>
                        <div class="content">
                            <a class="header" href="//api.kcwiki.moe/slotitem/1">装备基本信息</a>
                            <div class="description">api.kcwiki.moe/slotitem/{ID}</div>
                        </div>
                    </div>
                    <div class="item"> <i class="large linkify middle aligned icon"></i>
                        <div class="content">
                            <a class="header" href="http://api.kcwiki.moe/start2">Start2 数据</a>
